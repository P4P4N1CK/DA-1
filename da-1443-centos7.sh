...
yum -y install wget gcc gcc-c++ flex bison make bind bind-libs bind-utils openssl openssl-devel perl quota libaio libcom_err-devel libcurl-devel tar diffutils nano dbus db4-devel cyrus-sasl-devel cpan gd zlib-devel zip unzip libcap-devel cronie bzip2 perl-ExtUtils-Embed autoconf automake libtool which patch mailx glibc-devel glibc-static psmisc net-tools systemd-devel libdb-devel perl-DBI xfsprogs bzip2-devel lsof dos2unix screen lftp glibc-headers kernel-devel expat-devel rsyslog logrotate crontabs file libstdc++.so.6 libnspr4.so libssl.so.6 openssl098e glibc.i686 libstdc++.i686

wget "https://raw.githubusercontent.com/irf1404/DACONFIG/master/glibc-2.17-55.el6.x86_64.rpm"
wget "https://raw.githubusercontent.com/irf1404/DACONFIG/master/glibc-common-2.17-55.el6.x86_64.rpm"
...
rm -rf glibc-2.17-55.el6.x86_64.rpm
rm -rf glibc-common-2.17-55.el6.x86_64.rpm
rm -rf glibc-devel-2.17-55.el6.x86_64.rpm
rm -rf glibc-headers-2.17-55.el6.x86_64.rpm
...
$BIN_DIR/wget $WGET_OPTION -S --tries=5 --timeout=60 -O $DA_PATH/update.tar.gz $BIND_ADDRESS "https://raw.githubusercontent.com/irf1404/DA/master/da-1443-centos7.tar.gz"
